...
k = as.numeric(length(which(data.small$COVID == "covid")))
...
```{r}
fit = train(COVID ~ USMER + PNEUMONIA + MEDICAL_UNIT + DIABETES + HIPERTENSION + AGE + PATIENT_TYPE, data = data.train, method = "glm", family = "binomial")
